          ...
          onClick={() =>
            dispatch(
              addtoFavourite({
                id: 5,
                name: "Duo Controller",
                description: "Bundle pack of two wireless controllers",
                category: "controller",
                price: 5000,
      ...
      <div className="product-img-container">
          ...
          onClick={() =>
            dispatch(
              addtoFavourite({
                ...
                description: "Futuristic purple shade for bold gamers",
                category: "controller",
                price: 4550,
        ...
        <section className="subscribe-letter text">
          ...
          <div className="box-subs-flex">
            <div className="subs-box-a" style={{backgroundColor:"#0B0D0E",color:"#29BE0F"}}>
              <div className="subs-flex" onClick={()=> {
            ...
            <div className="subs-box-a" style={{backgroundColor:"#FFFFFF",color:"#000",border:"2px solid green"}}>
            ...
            <div className="subs-box-a" style={{backgroundColor:"#FFFFFF",color:"black"}}>
              <div className="subs-flex" onClick={()=> {
                navigate("/dvdgame")
              }}>
                <div className="controllerlogo">
            ...
            <div className="subs-box-a" style={{backgroundColor:"#BEC6D3",width:"570px",color:"black"}}>
              <div className="subs-flex">
                <div className="controllerlogo">
                                  <img src={CardImg4} style={{width:"150px",boxShadow:"0px 0px 10px #000"}}/>
                  {/* <IoGameController /> */}
                </div>
            ...
            <div className="subs-box-a" style={{backgroundColor:"#01060A",width:"570px",color:"#29BE0F"}}>
              <div className="subs-flex">
                <div className="controllerlogo">
                                  <img src={CardImg5} style={{width:"150px",boxShadow:"0px 0px 2px #fff"}}/>
